...
def registered_swimmers():
    register_swimmers_table={'Name':[],"Age":[],"Gender":[],"Status":[]}
...
while main_program == True:
    user_choice = input("\n\n\nFor register press                  => 1\nFor recording swimmer time press    => 2\nTo search individual press          => 3\nTo search individual by event press => 4\nTo remove swimmer press             => 5\nDisplay all registered swimmers     => 6\nDisplay all Unposted swimmers       => 7\nDisplay all Posted swimmers         => 8\nTo execute program press            => 9\n\n******************************************************************\n\nEnter Your Option :: ")
